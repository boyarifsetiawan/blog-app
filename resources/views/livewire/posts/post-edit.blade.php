    ...
    <div>
        <x-slot name="header">
            <div class="px-12 flex justify-between">
                ...
                <a wire:navigate href="{{ route('posts.index') }}"
                    class="px-4 py-2 rounded-md bg-indigo-500 text-white">All
                    Posts</a>
            </div>
        </x-slot>
        <div class="w-1/2 bg-white mx-auto mt-2 px-5 py-4">
            ...
            <form class="w-full mx-auto">
                ...
                <div class="mb-5">
                    <label for="form.image" class="block mb-2 text-sm font-medium text-gray-900">Image</label>
                    ...
                    <div class="flex justify-evenly mx-auto px-2 py-2">
                        @if ($form->image)
                            <div class="">
                                <span>Current Image :</span>
                                <img src="{{ Storage::url($form->image) }}"
                                    class="rounded-md shadow-lg shadow-amber-300" width="100" height="100"
                                    alt="">
                            </div>
                        @endif
                        @if ($image)
                            <div class="">
                                ...
                                <img class="rounded-md shadow-lg shadow-amber-300" width="100" height="100"
